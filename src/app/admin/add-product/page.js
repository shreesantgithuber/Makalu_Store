...
const AddProductPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    const newProduct = {
      ...
      // Add more specific fields based on productType
    };
      ...
      <div className="max-w-md mx-auto bg-white shadow-md rounded-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <select id="productType" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={productType} onChange={(e) => setProductType(e.target.value)} required>
          ...
          {productType === 'tent' || productType === 'box-tent' || productType === 'dining-tent' ? (
            <div>
              ...
              <input type="number" id="capacity" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={capacity} onChange={(e) => setCapacity(e.target.value)} />
            </div>
          ) : null}
          {productType === 'oxygen' ? (
            <>
              <div>
                ...
                <input type="text" id="cylinderSize" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={cylinderSize} onChange={(e) => setCylinderSize(e.target.value)} />
              </div>
              <div>
                <label htmlFor="regulatorType" className="block text-gray-700 text-sm font-bold mb-2">Regulator Type:</label>
                <input type="text" id="regulatorType" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value={regulatorType} onChange={(e) => setRegulatorType(e.target.value)} />
              </div>
            </>
          ) : null}
